...
var FormInput = React.createClass({
  ...
  render: function () {
    ...
    return (<div>
      ...
      <label className="sr-only" htmlFor={this.props.name}><FormattedHTMLMessage message={this.getIntlMessage(this.props.label)} /></label>
      <input name={this.props.name} type={this.props.type} onFocus={this.props.onFocus} tabIndex={this.props.tabIndex} onKeyDown={this.checkForReturn} valueLink={this.props.valueLink} placeholder={this.getIntlMessage(this.props.label)} required={this.props.required} />
      </div>
