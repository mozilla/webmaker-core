...
var Page = React.createClass({
   ...
   * from this view.
   */
  queueEdit: function(elementId) {
    elementId = parseInt(elementId,10);
    if (this.edits.indexOf(elementId) === -1) {
      this.edits.push(elementId);
    }
  },
  ...
  followLinkDestination: function(parentProjectID, elementID) {
    ...
    if (java) {
      java.setView('/users/' + this.state.params.user + '/projects/' + parentProjectID + '/link',
